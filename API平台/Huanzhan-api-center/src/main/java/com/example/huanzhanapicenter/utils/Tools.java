package com.example.huanzhanapicenter.utils;
...
import com.example.huanzhanapicenter.common.BaseUserState;
...
public class Tools {
     ...
     * @return 用户状态
     */
    public static String UserExist(Apicenter user){
        if (user.getIsdelete().equals(BaseUserState.Exist)) return BaseCode.Code_Achieve ;
        return BaseCode.Code_Error ;
    }
